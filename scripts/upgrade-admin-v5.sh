...
TMP="$(mktemp -d "$HOME_DIR/.6ixmedia-admin-v5.XXXXXX")"
...
php -l "$HOME_DIR/admin.6ixmediasa.com/api/status.php" >/dev/null
echo "6ixMedia Admin v5 upgrade complete and verified."
