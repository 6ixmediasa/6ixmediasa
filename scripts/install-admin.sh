...
read -r -p "Database host [localhost]: " DB_HOST_INPUT
...
read -r -p "Admin email: " ADMIN_EMAIL_INPUT
read -r -s -p "Admin password (minimum 12 characters): " ADMIN_PASSWORD_INPUT; echo
